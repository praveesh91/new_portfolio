...
const GlobalStyle = createGlobalStyle`
  ...
  */
  ...
  .white-content header{
    background-color: #6934E1;
  }

  .white-content .project-title a:hover{
    color: #6934E1;
  }
  .white-content h1, .white-content .project-description p{
    color: #2f3c56 !important;
  }
  .white-content .project-description{
    background-color: #f16fa1;
    background-image: linear-gradient(83deg, #8b55f5, #f16fa1);
  }
  .white-content .email-link,
  .white-content .more-button,
  .white-content .send-button{
...
.white-content a.inline-link:hover,
.white-content h3 .company{
  color:#6934E1
}
...
.white-content .project-title,
.white-content h3 span,
.white-content .project-overline{
  color: var(--slate)
}
.white-content .input,
...
.white-content ul.skills-list li:before{
  color:#6934E1;
}
.white-content .inner ul li:before{
  color:#6934E1;
}
